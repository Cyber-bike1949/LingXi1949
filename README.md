...
[![Community Plugin](https://img.shields.io/badge/Obsidian-Community%20Plugin-22c55e?style=for-the-badge)](https://obsidian.md/plugins?id=lingxi)
[![License](https://img.shields.io/badge/license-GPL--3.0-blue?style=for-the-badge)](./LICENSE)
[![PTY](https://img.shields.io/badge/backend-Rust%20PTY-f97316?style=for-the-badge)](./rust-servers)

English / [简体中文](./README_ZH.md)

[Install](#installation) · [Quick Start](#quick-start) · [Features](#features) · [Screenshots](#visual-tour) · [Report Issues](https://github.com/Cyber-bike/Lingxi/issues) · [Telegram](https://t.me/+t6oRqhaw8c1jNzE1)
...
- Lingxi downloads the matching native PTY server from [GitHub Releases](https://github.com/Cyber-bike/Lingxi/releases). On first use of remote devices, it downloads the fixed-version platform-specific iroh `.node` runtime from unpkg, with jsDelivr and GitHub Releases as fallbacks. Native downloads are verified against bundled SHA-256 hashes; offline mode disables them and all update checks.
...
1. Download the matching `termesh-<version>-<platform>.zip` complete package from [GitHub Releases](https://github.com/Cyber-bike/Lingxi/releases), for example `win32-x64` on Windows x64.
...
1. Download `termesh-agent-win32-x64.exe` and its `.sha256` file from the latest [GitHub Release](https://github.com/Cyber-bike/Lingxi/releases/latest).
