...
export function migrateEnabledPluginId(pluginsDir, legacyId = 'termesh', pluginId = 'lingxi-bridge') {
...
export function migrateLegacyPluginData(pluginsDir, legacyId = 'termesh', pluginId = 'lingxi-bridge') {
