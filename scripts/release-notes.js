 ...
 *   node scripts/release-notes.js --version 1.3.0 --repository Cyber-bike/termesh --output release-body.md
 */
...
const DEFAULT_REPOSITORY = 'Cyber-bike/termesh';
...
export function renderReleaseBody({ version, changelogSection, repository = DEFAULT_REPOSITORY }) {
  ...
  return [
    ...
    '2. Click **Browse**, search for `Magpie Bridge`, and click **Install**',
    '3. Click **Enable** to start using Magpie Bridge',
    '4. On first use of remote devices, Magpie Bridge automatically downloads and verifies the platform-native runtime',
    '',
    '### BRAT (Early Updates)',
